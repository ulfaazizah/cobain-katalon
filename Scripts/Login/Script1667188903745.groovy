...
//buat direktori untuk naro hasil screenshot (user.dir direktori project)
String userDir = System.getProperty('user.dir')

String pathSSLogin = userDir + '/Screenshot/login-state.png'

WebUI.takeScreenshot(pathSSLogin)
